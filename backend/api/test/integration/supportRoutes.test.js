...
describe('Support Routes', () => {
  ...
  describe('GET /tickets/:id', () => {
    ...
    it('returns 404 for a 00000000-0000-0000-0000-000000000000 ticket', async () => {
      const res = await request(buildApp())
  ...
  describe('Support Ticket Comments', () => {
    ...
    it('POST /tickets/:id/comments returns 404 for commenting on 00000000-0000-0000-0000-000000000000 ticket', async () => {
      const res = await request(buildApp())
        .post('/api/support/tickets/00000000-0000-0000-0000-000000000000/comments')
        .set(CUSTOMER_HEADERS)
        .send({ message: 'Hello' });
