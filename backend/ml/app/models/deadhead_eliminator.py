...
# Deadhead economics defaults. Callers can override these through truck_specs.
...
def find_return_loads(
    ...
    for load in available_loads:
        try:
            ...
            # A return load that loses money is not an economically valid
            # recommendation, regardless of its gross payment or proximity.
