...
router.post('/api/deliveries/:id/geofence-confirm', authenticate, async (req, res) => {
  ...
  if (geofence_radius_m !== undefined && (!Number.isFinite(geofenceRadiusM) || geofenceRadiusM <= 0)) {
