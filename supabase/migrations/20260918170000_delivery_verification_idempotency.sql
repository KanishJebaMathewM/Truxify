-- =============================================================================
-- Migration: Delivery Verification Idempotency & OTP Replay Protection
-- =============================================================================

ALTER TABLE delivery_otps ADD COLUMN IF NOT EXISTS used_at timestamptz;
CREATE INDEX IF NOT EXISTS idx_delivery_otps_used_at ON delivery_otps (used_at);

ALTER TABLE orders ADD COLUMN IF NOT EXISTS delivery_verification_status text NOT NULL DEFAULT 'pending_verification';
